...
<div className='privacy-policy-area ptb-100'>
        <div className='container'>
          <div className='privacy-policy-content'>
            ...
            <p>
              This site is provided by <strong>Prototype.Next</strong>.{' '}
              <strong>Prototype.Next</strong> collects information in several ways from
            ...
            <p>
              <strong>Prototype.Next</strong> accepts the following payment methods:
            </p>
            <ul>
              <li>
              ...
              <li>
                <strong>Prototype.Next</strong> features a Fast Checkout option, allowing
