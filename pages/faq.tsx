            ...
            <ul className='nav nav-tabs' id='myTab' role='tablist'>
              <li className='nav-item' role='presentation'>
                <button
                  ...
                  onClick={() => toggleTab(1)}
                  id='Prototype.Next-direct-tab'
                  data-bs-toggle='tab'
                  data-bs-target='#Prototype.Next-direct'
                  type='button'
                  role='tab'
                  aria-controls='Prototype.Next-direct'
                  aria-selected='true'
                >
                  <i className='bx bx-flag'></i>
                  Prototype.Next Direct
                </button>
              </li>
              <li className='nav-item' role='presentation'>
                <button
                    ...
                    >
                      ...
                      >
                        {clicked === index ? (
                          <div className='accordion-body'>
                            <p>
                              <strong>Prototype.Next</strong> is always looking for
                              ...
                              with <strong>Prototype.Next</strong>, a company who values
...
Faq.defaultProps = {
  data: [
    ...
    {
      question: 'What are the requirements for registering an Prototype.Next Direct account?',
      answer:
        'Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip. Conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
    },

    {
      question: 'Which name should I use to register my Prototype.Next Direct account?',
      answer:
        'Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip. Conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
    },
    {
    ...
    {
      question: 'Which payment methods are supported by Prototype.Next Direct?',
      answer:
        'Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip. Conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
    },
    {
      question: 'Is Prototype.Next Direct GDPR compliant?',
      answer:
        'Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip. Conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
    },
    {
