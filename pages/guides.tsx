          ...
          <div className='guides-content'>
            ...
            <div className='row m-0'>
              <div className='col-lg-3 col-md-12 p-0'>
                <div className='box'>
                  <h3>Step 1</h3>
                  <span>Create a Prototype.Next Account</span>
                </div>
              </div>
          ...
          <div className='guides-content'>
            ...
            <div className='row m-0'>
              <div className='col-lg-3 col-md-12 p-0'>
                <div className='box'>
                  <h3>Step 2</h3>
                  <span>Select a coin. Prototype.Next</span>
                </div>
              </div>
              <div className='col-lg-9 col-md-12 p-0'>
                <div className='content'>
          ...
          <div className='guides-content'>
            ...
            <div className='row m-0'>
              ...
              <div className='col-lg-9 col-md-12 p-0'>
                <div className='content'>
                  <p>
                    <strong>Prototype.Next</strong> accepts the following payment
                    methods:
                  </p>
                  <ul>
                    <li>
                    ...
                    <li>
                      <strong>Prototype.Next</strong> features a Fast Checkout option,
